  ...
  .directive('end', function ($http, $location, configuration) {
    ...
    var End = React.createClass({displayName: "End",
      ...
      render: function () {
        ...
        var entries = _.map(_.range(6), function (i) {
          ...
          return React.createElement("div", {className: "pure-u-1-6"}, 
            React.createElement("div", {className: className, onClick: function () {
              self.handleActivate(i)
            }}, score)
          );
        });

        return React.createElement("div", {className: "pure-g endinput"}, 
          entries
        )
      }
    });
    ...
    var EndPage = React.createClass({displayName: "EndPage",
      ...
      render: function () {
        ...
        var numpadButtons = _.map(_.range(0, 11), function (i) {
          i = 10 - i;
          return React.createElement("div", {className: "pure-u-1-4"}, 
            React.createElement("div", {className: 'numpad__button numpad__button--' + getRing(i), onClick: function () {
        ...
        return React.createElement("div", null, 
          React.createElement(End, {ref: "end", scores: this.props.scores}), 
          React.createElement("button", {onClick: this.handleDone, className: "pure-u-1 pure-button button-success"}, "Done"), 
          React.createElement("div", {className: "pure-g numpad"}, 
            numpadButtons
          )
        )
      }
    ...
    return {
      ...
      link: function ($scope, element) {
        ...
        var component = React.render(React.createElement(EndPage, {id: $scope.id, scorecardId: $scope.scorecardId}), root);
